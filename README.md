...
- 🔭 I'm currently working on:
  -  **[From Refusal Tokens to Refusal Control: Discovering and Steering Category-Specific Refusal Directions](https://github.com/RishabSA/interp-refusal-tokens)**, **🎉 Accepted to the 2025 NeurIPS workshop on Mechanistic Interpretability 🎉**
  ...
  -  **[AutoNeuroNet](https://github.com/RishabSA/AutoNeuroNet)**, a fully custom **C++** library with **Python bindings** for automatic differentiation, matrices, and neural networks.
